...
import { useState } from "react";
import { Link } from "react-router";
import {ChevronFirst, Leaf, User} from "lucide-react"; // Ensure correct icons import

export default function Navigation() {
    const [isCollapsed, setIsCollapsed] = useState(false);

    return (
        <header className="bg-green-900 shadow-lg text-white font-bold mt-5  mx-4 md:mx-12 rounded-l-3xl rounded-r-3xl">
            <nav className="px-4 py-4 flex items-center justify-between">
                ...
                >
                    ...
                    <li>
                        <Link
                            to="/crops"
                            className="hover: hover:text-green-600 transition duration-300"
                        >
                            Crops
                        </Link>
                    </li>
